...
class DataSpeech():
	...
	def LoadDataList(self):
		...
		if(self.type=='train'):
			...
			filename_wavlist_primewords = 'primewords' + self.slash + 'train.wav.lst'
			...
			filename_symbollist_primewords = 'primewords' + self.slash + 'train.syllabel.txt'
		elif(self.type=='dev'):
			...
			filename_wavlist_primewords = 'primewords' + self.slash + 'dev.wav.lst'
			...
			filename_symbollist_primewords = 'primewords' + self.slash + 'dev.syllabel.txt'
		elif(self.type=='test'):
			...
			filename_wavlist_primewords = 'primewords' + self.slash + 'test.wav.lst'
			...
			filename_symbollist_primewords = 'primewords' + self.slash + 'test.syllabel.txt'
		else:
		...
		self.dic_wavlist_primewords,self.list_wavnum_primewords = get_wav_list(self.datapath + filename_wavlist_primewords)
		...
		self.dic_symbollist_primewords,self.list_symbolnum_primewords = get_wav_symbol(self.datapath + filename_symbollist_primewords)
	...
	def GetDataNum(self):
		...
		num_wavlist_primewords = len(self.dic_wavlist_primewords)
		num_symbollist_primewords = len(self.dic_symbollist_primewords)

		if(num_wavlist_thchs30 == num_symbollist_thchs30 and 
			num_wavlist_stcmds == num_symbollist_stcmds and 
			num_wavlist_aishell == num_symbollist_aishell and 
			num_wavlist_primewords == num_symbollist_primewords):
			DataNum = num_wavlist_thchs30 + num_wavlist_stcmds + num_wavlist_aishell + num_wavlist_primewords
		else:
			DataNum = -1
	...
	def GetData(self,n_start,n_amount=1):
		...
		if(self.type=='train'):
			...
			if(n_start < 10000):
			...
			elif(n_start >= 110000 and n_start < 230098):
			...
			elif(n_start >=10000 and n_start < 110000):
				...
				filename = self.dic_wavlist_primewords[self.list_wavnum_primewords[n_start-230098]]
				list_symbol=self.dic_symbollist_primewords[self.list_symbolnum_primewords[n_start-230098]]
		elif(self.type=='dev'):
			# 读取一个文件
			if(n_start < 893):
				filename = self.dic_wavlist_thchs30[self.list_wavnum_thchs30[n_start]]
				list_symbol=self.dic_symbollist_thchs30[self.list_symbolnum_thchs30[n_start]]
			elif(n_start >= 1493 and n_start < 16819):
			...
			elif(n_start >= 893 and n_start < 1493):
				...
				filename = self.dic_wavlist_primewords[self.list_wavnum_primewords[n_start-16819]]
				list_symbol=self.dic_symbollist_primewords[self.list_symbolnum_primewords[n_start-16819]]
		else:
			if(n_start < 2495):
				filename = self.dic_wavlist_thchs30[self.list_wavnum_thchs30[n_start]]
				list_symbol=self.dic_symbollist_thchs30[self.list_symbolnum_thchs30[n_start]]
			elif(n_start >= 4495 and n_start < 9568):
			...
			elif(n_start >= 2495 and n_start < 4495):
				...
				filename = self.dic_wavlist_primewords[self.list_wavnum_primewords[n_start-9568]]
				list_symbol=self.dic_symbollist_primewords[self.list_symbolnum_primewords[n_start-9568]]			
