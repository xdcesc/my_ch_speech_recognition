...
gen_label('train.wav.lst', 'train.syllabel.txt')
gen_label('test.wav.lst', 'test.syllabel.txt')
gen_label('dev.wav.lst', 'dev.syllabel.txt')
# 修正train, dev, test的音频文件列表，将标注中不存在的文件删除
fix_list('train.wav.lst', 'train.syllabel.txt')
fix_list('test.wav.lst', 'test.syllabel.txt')
fix_list('dev.wav.lst', 'dev.syllabel.txt')